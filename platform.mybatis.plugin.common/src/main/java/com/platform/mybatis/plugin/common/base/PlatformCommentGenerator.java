 ...
 * @date:2018年9月1日 下午9:03:00
 */
public class PlatformCommentGenerator implements CommentGenerator {
	...
	public PlatformCommentGenerator() {
		super();
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable) {
		...
		StringBuilder sb = new StringBuilder();
		TableConfiguration configure = introspectedTable.getTableConfiguration();
		if (null != configure.getSchema()) {
			field.addJavaDocLine("//" + (sb.append(" table name:" + configure.getSchema() + "." + configure.getTableName())).toString()); // ); //$NON-NLS-1$
		} else {
			field.addJavaDocLine("//" + (sb.append(configure.getTableName())).toString()); // ); //$NON-NLS-1$
		}
	}
...
//		method.addJavaDocLine("// " + getDateString()); //$NON-NLS-1$
	}
